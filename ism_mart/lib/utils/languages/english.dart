...
//////////////////////////////////////////////////////////
        ...
        key.memPlan1Desc3: 'Will have only access to the products and stores to visit that are opened by default or kept opened by the Vendors & Businesses to visit.',
        key.memPlan1Desc4: 'They can buy anything at their own as a direct customers with mutual understanding with the seller; ISMMART will not be responsible or back up in case of any issues in such deal.',

        key.memPlan2Title: 'PRO',
        key.memPlan2Desc1: 'A free one month trial',
        key.memPlan2Desc2: 'Can sell anything on ISMMART platform',
        key.memPlan2Desc3: 'Will have access to all products and stores to visit.',
        key.memPlan2Desc4: 'All deals by Premium Members on ISMMART will be backed up by ISMMART. We will be responsible for smooth transactions and delivery of products. ISMMART will guarantee to honor the mutual understanding that both Seller and Buyer have agreed upon.',
        key.memPlan2Desc5: 'Unlimited deliveries on eligible items.',
        key.memPlan2Desc6: 'Premium Members will have worry less access to all businesses worldwide, both as a Seller & Buyer as ISMMART will be directly guaranteeing and verifying such members and any deals they do.',
        key.memPlan2Desc7: 'As all Premium Members are scrutinized and are verified through ISMMART verification process, so all such members can do worry less trade with each other, anywhere in the World.',
        ...
        key.memPlan3Desc6: 'Get a chance to place products in our physical stores.',
        key.memPlan3Desc7: 'Unlimited deliveries on eligible items.',
        key.memPlan3Desc8: 'Premium Members will have worry less access to all businesses worldwide, both as a Seller & Buyer as ISMMART will be directly guaranteeing and verifying such members and any deals they do.',
        key.memPlan3Desc9: 'As all Premium Members are scrutinized and are verified through ISMMART verification process, so all such members can do worry less trade with each other, anywhere in the World.',
