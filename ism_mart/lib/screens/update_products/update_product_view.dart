...
import 'package:ism_mart/screens/update_product_images/update_product_images_view.dart';

class UpdateProductView extends GetView<SellersController> {
  const UpdateProductView({Key? key, this.productId, this.images}) : super(key: key);
  final int? productId;
