...
class UpdateVendorProfileView extends StatelessWidget {
  ...
  final UpdateVendorProfileViewModel viewModel = Get.put(
      UpdateVendorProfileViewModel(Get.find()));
    ...
    return CustomTextField3(
      ...
      validator: (value) {
        return Validator().validateName(
            value, errorToPrompt: langKey.storeNameReq.tr);
      },
    );
  }
  ...
  Widget ownerNameField() {
    return CustomTextField3(
      ...
      validator: (value) {
        return Validator().validateName(
            value, errorToPrompt: langKey.ownerName.tr);
      },
    );
  }
      ...
      child: CustomTextField3(
        ...
        validator: (value) {
          return Validator().validateDefaultTxtField(
              value, errorPrompt: langKey.storeDescReq.tr);
        },
        keyboardType: TextInputType.text,
      ),
    );
